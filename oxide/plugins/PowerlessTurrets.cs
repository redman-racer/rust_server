...
namespace Oxide.Plugins
{
    ...
    public class PowerlessTurrets : RustPlugin
    {
        ...
        private class TurretManager
        {
            ...
            {
                List<AutoTurret> turretList = Pool.Get<List<AutoTurret>>();
                ...
                Pool.FreeUnmanaged(ref turretList);
            }
            ...
            {
                List<SamSite> samSiteList = Pool.Get<List<SamSite>>();
                ...
                Pool.FreeUnmanaged(ref samSiteList);
            }
