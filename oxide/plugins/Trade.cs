    ...
    class Trade : RustPlugin
    {
        ...
        void ccTrade (ConsoleSystem.Arg arg)
        {
            ...
            if (arg.Connection.player == null)
                return;
            var args = (arg.Args == null || arg.Args.Length == 0) ? Array.Empty<string>() : Array.ConvertAll(arg.Args, str => str.ToString());
            cmdTrade(arg.Connection.player as BasePlayer, arg.cmd.Name, args);
        }
