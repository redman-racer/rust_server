...
namespace Oxide.Plugins
{
    ...
    public class AutomaticAuthorization : RustPlugin
    {
        ...
        private List<ulong> GetAuthorNameIDs(ulong playerId, AutoAuthType autoAuthType)
        {
        ...
        private void CCmdAutoAuthUI(ConsoleSystem.Arg arg)
        {
            ...
            {
                case "teams":
                    HandleShareUICommand(player, shareData, ShareType.Teams, args);
                    return;

                case "friends":
                    HandleShareUICommand(player, shareData, ShareType.Friends, args);
                    return;

                case "clans":
                    HandleShareUICommand(player, shareData, ShareType.Clans, args);
                    return;
            }
        }
